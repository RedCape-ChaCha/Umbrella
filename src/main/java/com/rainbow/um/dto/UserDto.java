...
public class UserDto implements Serializable {
	...
	public UserDto(String user_number, String user_email, String user_password, String user_phone, String user_zip,
			String user_address, String user_detail, String user_delflag, String user_regdate, String user_mileage,
			String user_grade, String user_api) {
		super();
	...
	public String toString() {
		return "UserDto [user_number=" + user_number + ", user_email=" + user_email + ", user_password=" + user_password
				+ ", user_phone=" + user_phone + ", user_zip=" + user_zip + ", user_address=" + user_address
				+ ", user_detail=" + user_detail + ", user_delflag=" + user_delflag + ", user_regdate=" + user_regdate
				+ ", user_mileage=" + user_mileage + ", user_grade=" + user_grade + ", user_api=" + user_api + "]";
	}
