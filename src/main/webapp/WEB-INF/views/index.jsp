...
<script type="text/javascript">
	...
	function fnSearchMonth(searchMonth) {
		$("#holidayWrap").load("/yslib/main/include/holiday.do?searchMonth="+searchMonth);
	}
</script>
</head>
<body>
	...
	function fnLoginProc() {
		...
		form.action = "/yslib/main/include/loginProc.do";
		form.submit();
	}
</script>
							...
							<article class="loginArea">
								...
								<form name="mainLoginForm" id="mainLoginForm" method="post">
									<div class="inputGroup">
										<div class="inpArea id themeBG">
											<label for="userId" class="themeColor"><span
												class="blind">아이디</span></label> <input type="text" id="userId"
												name="userId" placeholder="아이디" style="ime-mode: disabled;">
										</div>
										<div class="inpArea pw themeBG">
											<label for="userPw" class="themeColor"><span
								...
								<div class="menuLink">
									<a
										href="https://library.gangnam.go.kr/intro/memberJoinIntro.do">회원가입</a>
						...
						function fnHolidaySearchMonth(month) {
							$("#holidayWrap").load("/yslib/main/include/holiday.do", {searchMonth : month});
						}
					</script>
						...
						<article class="guideArea">
							...
							<a href="40073/contents.html" title="도서관 이용시간 상세보기" class="more"><span
